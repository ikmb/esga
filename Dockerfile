...
RUN mkdir -p /opt/spaln && cd /opt/spaln && wget https://github.com/ogotoh/spaln/archive/refs/tags/Ver2.4.3.tar.gz && tar -xvf Ver.2.4.3.tar.gz \
	&& mv spaln-Ver.2.4.3 2.4.3 && rm Ver.2.4.3.tar.gz \
