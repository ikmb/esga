...
ENV PATH /opt/conda/envs/esga-1.1/bin:/opt/conda/envs/esga-1.1/opt/pasa-2.4.1:/opt/bin:/opt/spaln/2.4.3/bin:$PATH
...
RUN apt-get -y update && apt-get -y install make gcc g++ zlib1g-dev zlib1g liburi-perl
