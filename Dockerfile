...
RUN mkdir -p /opt/spaln && cd /opt/spaln && wget https://github.com/ogotoh/spaln/archive/refs/tags/ver.2.4.5.tar.gz && tar -xvf ver.2.4.5.tar.gz \
	&& mv spaln-ver.2.4.5 2.4.5 && rm ver.2.4.5.tar.gz \
