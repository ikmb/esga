...
while (<$IN>) {
	...
	my $cmd_run = "exonerate --model protein2genome --softmasktarget --percent 60 --bestn 1 --minintron 20 --maxintron $max_intron_size  --showalignment false --showtargetgff true $query_fa $genome > $acc.exonerate.align\n";
